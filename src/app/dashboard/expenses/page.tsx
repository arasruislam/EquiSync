...
export default function ExpensesPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">Track operational costs, software licenses, and office overheads.</p>
          </div>
        </div>
      ...
      <div className="bg-[#050B18] border border-white/5 rounded-2xl overflow-hidden shadow-lg shadow-blue-900/5">
        <div className="p-4 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3 bg-black/40 border border-white/5 rounded-xl px-3 py-2 w-full max-w-sm">
            <Search className="w-4 h-4 text-gray-500" />
            <input type="text" placeholder="Search expenses or vendors..." className="bg-transparent text-sm text-white placeholder:text-gray-700 outline-none w-full" />
          </div>
        </div>
          ...
          <table className="w-full text-center border-collapse">
            <thead>
              <tr className="border-b border-white/5 bg-white/[0.02]">
                ...
                <th className="px-6 py-4 text-[10px] font-black text-gray-500 uppercase tracking-widest text-center">Description</th>
                <th className="px-6 py-4 text-[10px] font-black text-gray-500 uppercase tracking-widest text-center">Net Amount</th>
                <th className="px-6 py-4 text-[10px] font-black text-gray-500 uppercase tracking-widest text-center">Attribution</th>
            ...
            <tbody className="divide-y divide-white/5">
              {isLoading ? (
                ...
                <tr><td colSpan={5} className="px-6 py-12 text-center text-gray-500">No expense records found.</td></tr>
              ) : (
                expenses.map((e) => (
                  <tr key={e._id} className="hover:bg-white/[0.02] transition-colors group">
                    <td className="px-6 py-4 text-sm text-gray-400 whitespace-nowrap text-center">{formatDate(e.date)}</td>
                    <td className="px-6 py-4 text-center">
                      <div className="flex justify-center">
                        <div className="flex items-center gap-2 text-[9px] font-black tracking-widest uppercase bg-blue-500/5 px-2.5 py-1.5 rounded-lg border border-blue-500/10 shadow-sm">
                          ...
                          <span className="text-blue-400">{e.category}</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center justify-center">
                        <span className="text-sm font-bold text-white group-hover:text-blue-400 transition-colors text-center">{e.description}</span>
                        <span className="text-[10px] text-gray-600 font-bold uppercase tracking-tight text-center">{e.vendor || "Direct Outflow"}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <div className="flex flex-col items-center justify-center">
                        <span className="text-sm font-black text-white tracking-widest text-center">{formatCurrency(e.amountBDT, "BDT")}</span>
                        <div className="text-[10px] text-gray-600 font-bold text-center mt-0.5">~ {formatCurrency(e.amountUSD, "USD")}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
